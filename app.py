...
st.markdown("This application is a streamlit dashboard to Analysis Sentiments of the Tweets Ã°ÂÂÂ¦")
st.sidebar.markdown("This application is a streamlit dashboard to Analysis Sentiments of the Tweets Ã°ÂÂÂ¦")
...
if not st.sidebar.checkbox("Close",True,key = '3'):
    st.header("Word clould for %s sentiment" % (word_sentiment))
